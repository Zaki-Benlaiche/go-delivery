    ...
    <div style={{ minHeight: '100dvh', background: 'var(--bg)', color: 'var(--text)', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <img src="/logo.png" alt="Réserve-vite" style={{ width: '28px', height: '28px', borderRadius: '7px' }} />
          <span style={{
      ...
      <div style={{ maxWidth: '680px', margin: '0 auto', padding: '36px 20px 72px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }}>
          <div style={{
            ...
            <img src="/logo.png" alt="Réserve-vite" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>
